...
print("Test de normalitat per la distribució de la mostra de botigues en zones urbanes")
shapiro.test(ageHealthy)
print("Test de normalitat per la distribució de la mostra de botigues en zones rurals")
